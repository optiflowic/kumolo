...
type UserMetadata struct {
	...
	// PendingTOTPSecret holds a TOTP secret generated by AssociateSoftwareToken that has not
	// yet been confirmed by VerifySoftwareToken. Replaced (not accumulated) on every
	// AssociateSoftwareToken call; promoted to TOTPSecret on successful verification.
	PendingTOTPSecret string `json:"PendingTOTPSecret,omitempty"`
	// TOTPSecret is the active, verified TOTP secret used to validate SOFTWARE_TOKEN_MFA
	// challenge codes at sign-in. Set by VerifySoftwareToken; survives SetUserMFAPreference
	// disabling the factor (see set_user_mfa_preference.md).
	TOTPSecret string `json:"TOTPSecret,omitempty"`
	// SoftwareTokenMFAEnabled and PreferredMfaSetting are set by SetUserMFAPreference.
	// SoftwareTokenMFAEnabled gates the SOFTWARE_TOKEN_MFA sign-in challenge.
	SoftwareTokenMFAEnabled bool    `json:"SoftwareTokenMFAEnabled,omitempty"`
